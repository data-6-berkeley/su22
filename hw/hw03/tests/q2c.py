test = {   'name': 'q2c',
    'points': 3,
    'suites': [   {   'cases': [   {'code': '>>> isinstance(schools_stats_acc, Table)\nTrue', 'hidden': False, 'locked': False},
                                   ...
                                   {   'code': ">>> # Making sure schools_stats didn't change\n>>> schools_stats.labels == ('Name', 'Region', 'Applied', 'Admitted', 'Enrolled')\nTrue",
                                       'hidden': False,
                                       'locked': False},
                                   {   'code': ">>> all(np.isclose(schools_stats_acc.column('Acceptance Rate').take(np.arange(10)), np.array([0.35294118, 0.19811321, 0.20833333, 0.33333333, "
