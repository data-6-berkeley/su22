...
1. **Create a New Repository.** It may prompt you to do this after verifying your email; if it doesn’t, you can go to [GitHub](https://github.com/) and click the green “New” button. <figure style="text-align: center"> <img src="https://data6.org/su22/assets/lab08/fig2.png" style="width:80%; margin:auto; display:block"/> Figure 2 - Creating a New Repository </figure>
